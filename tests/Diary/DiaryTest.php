...
class DiaryTest extends TestCase
{
     ...
     */
    public function it_writes_an_entry_based_on_macronutrients()
    {
        ...
        $entry = $diary->writeMacronutrients($macronutrients, dishName: 'Banana', mealTime: 'dinner');
        ...
        $this->assertSame(10, $entry->fat);
        $this->assertSame(30, $entry->carbohydrates);
        $this->assertSame(4, $entry->protein);
        $this->assertSame(4 * 4 + 30* 4 + 10 * 9, $entry->calorie);
